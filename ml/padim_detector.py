...
def run_quietly(function, *args, **kwargs):
    """Run noisy third-party model code without flooding app/notebook output."""
...
@lru_cache(maxsize=1)
def load_padim_runtime(checkpoint_path: str, accelerator: str = "auto") -> tuple[object, object]:
...
def predict_with_padim(
    ...
    *,
    ...
    model, engine = load_padim_runtime(str(checkpoint_path), accelerator)
