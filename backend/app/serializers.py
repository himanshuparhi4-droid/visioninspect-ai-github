...
def inspection_to_response(inspection: Inspection) -> InspectionResponse:
    return InspectionResponse(
        ...
        raw_classification_confidence=inspection.raw_classification_confidence,
        classification_confidence_calibrated=inspection.classification_confidence_calibrated,
        subtype_model_status=inspection.subtype_model_status,
        subtype_model_macro_f1=inspection.subtype_model_macro_f1,
        manual_review_required=inspection.manual_review_required,
        detector_engine=inspection.detector_engine,
        detector_kind=inspection.detector_kind,
        classifier_engine=inspection.classifier_engine,
        detector_fallback_used=inspection.detector_fallback_used,
        detector_fallback_reason=inspection.detector_fallback_reason,
        classifier_fallback_used=inspection.classifier_fallback_used,
        classifier_fallback_reason=inspection.classifier_fallback_reason,
        ...
        rework_ticket_id=inspection.rework_ticket_id,
        rework_ticket_number=inspection.rework_ticket_number,
        rework_ticket_status=inspection.rework_ticket_status,
